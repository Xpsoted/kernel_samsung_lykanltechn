...
mkdir out
chmod -R 777 out
make -C $(pwd) O=out -j32 ARCH=arm64 CROSS_COMPILE=$(pwd)/../PLATFORM/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- lykanlte_chn_open_defconfig
